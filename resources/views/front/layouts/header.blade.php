          ...
          <div class="row">
              <div class="col-lg-8 col-md-8">
                <ul class="top-info text-center text-md-left">
                    <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">41 İzmit, Kocaeli</p>
                    </li>
                </ul>
              </div>
              <!--/ Top info end -->
                  ...
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          <p class="info-box-title">İletişim</p>
                          <p class="info-box-subtitle">(+90) 539-838-0962</p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          <p class="info-box-title">E-posta Adresimiz</p>
                          <p class="info-box-subtitle">iletisim@izmitelektrik.com</p>
                      </div>
                    </div>
                  </li>
    ...
    <div class="container">
        ...
        <div class="search-block" style="display: none;">
          <label for="search-field" class="w-100 mb-0">
            <input type="text" class="form-control" id="search-field" placeholder="Arama yapın">
          </label>
